...
GENCC_REFERENCE_NOTES = (
    ...
    "opaque truncated.next_cursor that is release-bound (refresh-safe); offsets and "
    "cursors are only valid for the gencc_release shown in _meta. The invalid_input "
